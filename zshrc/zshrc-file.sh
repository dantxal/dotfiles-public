...
. ~/github/dotfiles-public/zshrc/alias
...
create_symlink ~/github/dotfiles-public/dantxal-nvim/nvim-lazyvim ~/.config/nvim
...
# ln -snf ~/github/dotfiles-public/dantxal-nvim/nvim-lazyvim ~/.config/nvim >/dev/null 2>&1
...
#   mkdir -p ~/github
#   cd ~/github
#   git clone https://github.com/dantxal/dotfiles-latest.git >/dev/null 2>&1
# fi
...
# pnpm
export PNPM_HOME="/Users/dantxal/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
